        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartWorkTime = table.Column<TimeOnly>(type: "time", nullable: true),
                    EndWorkTime = table.Column<TimeOnly>(type: "time", nullable: true),
                    WorkingDays = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    SlotDurationMinutes = table.Column<int>(type: "int", nullable: false),
                    BreakBetweenSlots = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TherapistSchedule_Therapists_TherapistProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StaffConnectionId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TherapistSchedule_TherapistProfileId",
